...
[System.Serializable]
public class SimulationControllerAdam {

	public bool Inspect = false;
    public AnimationInputHandlerFromAdamSimulation handler;
	...
	public class Style {
        ...
        public AnimationInputHandlerFromAdamSimulation handler;
		public bool Query(AnimationInputHandlerFromAdamSimulation handler) {
			if(Keys.Length == 0) {
				return false;
			}
