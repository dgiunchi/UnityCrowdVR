...
namespace SIGGRAPH_2017 {
	public class BioAnimation_NavMesh : MonoBehaviour {
	...
	#if UNITY_EDITOR
	[CustomEditor(typeof(BioAnimation_NavMesh))]
	public class BioAnimation_NavMesh_Editor : Editor {

			public BioAnimation_NavMesh Target;

			void Awake() {
				Target = (BioAnimation_NavMesh)target;
			}
