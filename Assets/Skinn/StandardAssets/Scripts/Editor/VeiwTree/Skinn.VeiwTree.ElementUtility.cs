...
{
    // ElementUtility and TreeElement are useful helper classes for back-end tree data structures.
    public static class ElementUtility
	{
		...
		// For updating depth values below any given element e.g after re-parenting elements
		...
		{
            while (child != null) { child = (T)child.Parent; if (elements.Contains(child)) return true; }
            return false;
		}
